  ...
  return (
    ...
    >
      ...
      <input
        ...
        value={number}
      ></input>
      <h1 className={"text-xl font-bold " + (isDark && "text-white")}>
        {number} th prime no: {prime}
      </h1>
    </div>
  );
};
